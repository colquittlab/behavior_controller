...
class AudioManager:
    ...
    def update(self, y):
        ...
        # if self.parent.recorder.params['threshold'] > 0:
        #     thresh = np.array(self.parent.recorder.params['threshold'])
        #     y = np.repeat(thresh, self.plot_params['xrange'][-1] + 1)
        # self.parent.audio_plot.plot(x=self.plot_params['xrange'], y=y, pen=(0,200,100))

...
class AudioRecord:
    def __init__(self, box, config):
        ...
        self.chunk = config.get('record_params', 'chunk')
        self.format = aa.PCM_FORMAT_S16_LE
        self.channels = 1
        self.rate = 44100
        self.threshold = config.get('record_params', 'threshold')
        self.silence_limit = config.get('record_params', 'silence_limit')
        self.prev_audio = config.get('record_params', 'prev_audio')
        self.min_dur = config.get('record_params', 'min_dur')
        self.outdir = config.get('record_params', 'oudir')
        self.stream = None
